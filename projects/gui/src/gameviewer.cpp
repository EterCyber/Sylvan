      ...
      m_moveIndex(0)
{
    ...
    m_viewFirstMoveBtn->setIcon(QIcon(":/icons/toolbutton/first-16x16"));
    ...
    m_viewPreviousMoveBtn->setIcon(QIcon(":/icons/toolbutton/previous-16x16"));
    ...
    m_viewNextMoveBtn->setIcon(QIcon(":/icons/toolbutton/next-16x16"));
    ...
    m_viewLastMoveBtn->setIcon(QIcon(":/icons/toolbutton/last-16x16"));
...
void GameViewer::setGame(const PgnGame* pgn)
{
    ...
    else
    {
        QMessageBox::critical(
                    ...
                    tr("This game is incompatible with Sylvan and cannot be shown."));
    }
    m_moveIndex = 0;
