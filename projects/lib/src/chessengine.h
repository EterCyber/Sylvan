 ...
 * either the UCI or UCCI chess protocol. Communication between the GUI
...
protected:
    /*!
         ...
         * for leading and trailing redspace. Otherwise only one
         * word is read.
         *
    ...
    /*!
         ...
         * except for leading and trailing redspace. Otherwise
    ...
    /*! Are evaluation scores from red's point of view? */
