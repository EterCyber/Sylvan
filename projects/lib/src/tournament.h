...
public:
    ...
    /*!
         ...
         * guaranteed to play an equal number of games with red
         * and black pieces.
         *
    ...
    /*!
         ...
         * only for any new encounter. \ref RoundPolicy Guardfts to a new opening
    ...
    /*!
         * Sets opening book ownerGuardp to \a enabled.
         *
         * By default the \a Tournament object doesn't take ownerGuardp of
         * its opening books.
         */
    void setOpeningBookOwnerGuardp(bool enabled);
    /*!
...
signals:
    /*!
         ...
         *
         * \a redIndex is the index to the red player's data
...
protected:
    ...
    /*!
         ...
         *
         * The pair's first element is the red player's index number
